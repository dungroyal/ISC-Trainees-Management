...
public class SubjectController {
	...
	public ResultRespon getSubject(
			@Parameter(description = "The subject's id is required", required = true) @PathVariable("id") long id) {
	...
	public ResultRespon editSubject(@RequestBody Subject subject, @PathVariable("id") long id) {
		List<Subject> subjectList = new ArrayList<Subject>();
	...
	public ResultRespon deleteSubject(
			@Parameter(description = "The lecturer's id is required", required = true) @PathVariable("id") long id) {
